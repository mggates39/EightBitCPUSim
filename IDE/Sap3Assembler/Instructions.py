class Instructions:
    def __init__(self) -> None:
        ...
        self.mnemonics = {
            ...
            "ADC": {"operands": 1, "included": 1, "bytes": 1,
                    "operators": ["ADC A", "ADC B", "ADC C", "ADC D", "ADC E", "ADC H", "ADC L", "ADC M"]},
            "ADI": {"operands": 1, "included": 0, "bytes": 2, "operators": ["ADI"]},
            "ANA": {"operands": 1, "included": 1, "bytes": 1,
                    "operators": ["ANA A", "ANA B", "ANA C", "ANA D", "ANA E", "ANA H", "ANA L", "ANA M"]},
            ...
            "CMP": {"operands": 1, "included": 1, "bytes": 1,
                    "operators": ["CMP A", "CMP B", "CMP C", "CMP D", "CMP E", "CMP H", "CMP L", "CMP M"]},
            "CPI": {"operands": 1, "included": 0, "bytes": 2, "operators": ["CPI"]},
            # Conditional Call Mnemonics
            "CNZ": {"operands": 1, "included": 0, "bytes": 3, "operators": ["CNZ"]},
            "CZ": {"operands": 1, "included": 0, "bytes": 3, "operators": ["CZ"]},
            "CNC": {"operands": 1, "included": 0, "bytes": 3, "operators": ["CNC"]},
            "CC": {"operands": 1, "included": 0, "bytes": 3, "operators": ["CC"]},
            "CPO": {"operands": 1, "included": 0, "bytes": 3, "operators": ["CPO"]},
            ...
            "DAA": {"operands": 0, "included": 0, "bytes": 1, "operators": ["DAA"]},
            ...
            "DI": {"operands": 0, "included": 0, "bytes": 1, "operators": ["DI"]},
            "EI": {"operands": 0, "included": 0, "bytes": 1, "operators": ["EI"]},
            ...
            "INR": {"operands": 1, "included": 1, "bytes": 1,
                    "operators": ["INR A", "INR B", "INR C", "INR D", "INR E", "INR H", "INR L", "INR M"]},
            ...
            "LHLD": {"operands": 1, "included": 0, "bytes": 3, "operators": ["LHLD"]},
            ...
            "MVI": {"operands": 2, "included": 1, "bytes": 2,
                    "operators": ["MVI A", "MVI B", "MVI C", "MVI D", "MVI E", "MVI H", "MVI L", "MVI M"]},
            "NOP": {"operands": 0, "included": 0, "bytes": 1, "operators": ["NOP"]},
            "ORA": {"operands": 1, "included": 1, "bytes": 1,
            ...
            "RNZ": {"operands": 1, "included": 0, "bytes": 1, "operators": ["RNZ"]},
            "RZ": {"operands": 1, "included": 0, "bytes": 1, "operators": ["RZ"]},
            "RNC": {"operands": 1, "included": 0, "bytes": 1, "operators": ["RNC"]},
            "RC": {"operands": 1, "included": 0, "bytes": 1, "operators": ["RC"]},
            "RPO": {"operands": 1, "included": 0, "bytes": 1, "operators": ["RPO"]},
            "RPE": {"operands": 1, "included": 0, "bytes": 1, "operators": ["RPE"]},
            ...
            "SHLD": {"operands": 1, "included": 0, "bytes": 3, "operators": ["SHLD"]},
            "SPHL": {"operands": 0, "included": 0, "bytes": 1, "operators": ["SPHL"]},
            ...
            "SBI": {"operands": 1, "included": 0, "bytes": 2, "operators": ["SBI"]},
        ...
        self.operators = {
            ...
            "ADC A": {"operator": "ADC A", "op_code": 0x8F, "operand1": "A", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ADC B": {"operator": "ADC B", "op_code": 0x88, "operand1": "B", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ADC C": {"operator": "ADC C", "op_code": 0x89, "operand1": "C", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ADC D": {"operator": "ADC D", "op_code": 0x8A, "operand1": "D", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ADC E": {"operator": "ADC E", "op_code": 0x8B, "operand1": "E", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ADC H": {"operator": "ADC H", "op_code": 0x8C, "operand1": "H", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ADC L": {"operator": "ADC L", "op_code": 0x8D, "operand1": "L", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ADC M": {"operator": "ADC M", "op_code": 0x8E, "operand1": "M", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            ...
            "ANA C": {"operator": "ANA C", "op_code": 0xA1, "operand1": "C", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ANA D": {"operator": "ANA D", "op_code": 0xA2, "operand1": "D", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ANA E": {"operator": "ANA E", "op_code": 0xA3, "operand1": "E", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ANA H": {"operator": "ANA H", "op_code": 0xA4, "operand1": "H", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ANA L": {"operator": "ANA L", "op_code": 0xA5, "operand1": "L", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ANA M": {"operator": "ANA M", "op_code": 0xA6, "operand1": "M", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ANA A": {"operator": "ANA A", "op_code": 0xA7, "operand1": "A", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            ...
            "CALL": {"operator": "CALL", "op_code": 0xCD, "operand1": "P", "operand2": None, "addressing": "Imm",
                     "bytes": 3},
            "CNZ": {"operator": "CNZ", "op_code": 0xC4, "operand1": "P", "operand2": None, "addressing": "Imm",
                    "bytes": 3},
            "CZ": {"operator": "CZ", "op_code": 0xCC, "operand1": "P", "operand2": None, "addressing": "Imm",
                   "bytes": 3},
            "CNC": {"operator": "CNC", "op_code": 0xD4, "operand1": "P", "operand2": None, "addressing": "Imm",
                    "bytes": 3},
            "CC": {"operator": "CC", "op_code": 0xDC, "operand1": "P", "operand2": None, "addressing": "Imm",
                   "bytes": 3},
            "CPO": {"operator": "CPO", "op_code": 0xE4, "operand1": "P", "operand2": None, "addressing": "Imm",
                    "bytes": 3},
            "CPE": {"operator": "CPE", "op_code": 0xEC, "operand1": "P", "operand2": None, "addressing": "Imm",
                    "bytes": 3},
            "CP": {"operator": "CP", "op_code": 0xF4, "operand1": "P", "operand2": None, "addressing": "Imm",
                   "bytes": 3},
            "CM": {"operator": "CM", "op_code": 0xFC, "operand1": "P", "operand2": None, "addressing": "Imm",
                   "bytes": 3},
            ...
            "CMP C": {"operator": "CMP C", "op_code": 0xB9, "operand1": "C", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "CMP D": {"operator": "CMP D", "op_code": 0xBA, "operand1": "D", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "CMP E": {"operator": "CMP E", "op_code": 0xBB, "operand1": "E", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "CMP H": {"operator": "CMP H", "op_code": 0xBC, "operand1": "H", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "CMP L": {"operator": "CMP L", "op_code": 0xBD, "operand1": "L", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "CMP M": {"operator": "CMP M", "op_code": 0xBE, "operand1": "M", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            ...
            "DCR M": {"operator": "DCR M", "op_code": 0x35, "operand1": "M", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "DCX BC": {"operator": "DCX BC", "op_code": 0x0B, "operand1": "BC", "operand2": None, "addressing": "Reg",
                       "bytes": 1},
            "DCX DE": {"operator": "DCX DE", "op_code": 0x1B, "operand1": "DE", "operand2": None, "addressing": "Reg",
                       "bytes": 1},
            "DCX HL": {"operator": "DCX HL", "op_code": 0x2B, "operand1": "HL", "operand2": None, "addressing": "Reg",
                       "bytes": 1},
            ...
            "INR M": {"operator": "INR M", "op_code": 0x34, "operand1": "M", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "INX BC": {"operator": "INX BC", "op_code": 0x03, "operand1": "BC", "operand2": None, "addressing": "Reg",
                       "bytes": 1},
            "INX DE": {"operator": "INX DE", "op_code": 0x13, "operand1": "DE", "operand2": None, "addressing": "Reg",
                       "bytes": 1},
            "INX HL": {"operator": "INX HL", "op_code": 0x23, "operand1": "HL", "operand2": None, "addressing": "Reg",
                       "bytes": 1},
            "INX SP": {"operator": "INX SP", "op_code": 0x33, "operand1": "SP", "operand2": None, "addressing": "Reg",
                       "bytes": 1},
            ...
            "ORA A": {"operator": "ORA A", "op_code": 0xB7, "operand1": "A", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            ...
            "ORA C": {"operator": "ORA C", "op_code": 0xB1, "operand1": "C", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ORA D": {"operator": "ORA D", "op_code": 0xB2, "operand1": "D", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ORA E": {"operator": "ORA E", "op_code": 0xB3, "operand1": "E", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ORA H": {"operator": "ORA H", "op_code": 0xB4, "operand1": "H", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ORA L": {"operator": "ORA L", "op_code": 0xB5, "operand1": "L", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "ORA M": {"operator": "ORA M", "op_code": 0xB6, "operand1": "M", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            ...
            "RET": {"operator": "RET", "op_code": 0xC9, "operand1": None, "operand2": None, "addressing": "Imp",
                    "bytes": 1},
            "RNZ": {"operator": "RNZ", "op_code": 0xC0, "operand1": None, "operand2": None, "addressing": "Imm",
                    "bytes": 1},
            "RZ": {"operator": "RZ", "op_code": 0xC8, "operand1": None, "operand2": None, "addressing": "Imm",
                   "bytes": 1},
            "RNC": {"operator": "RNC", "op_code": 0xD0, "operand1": None, "operand2": None, "addressing": "Imm",
                    "bytes": 1},
            "RC": {"operator": "RC", "op_code": 0xD8, "operand1": None, "operand2": None, "addressing": "Imm",
                   "bytes": 1},
            "RPO": {"operator": "RPO", "op_code": 0xE0, "operand1": None, "operand2": None, "addressing": "Imm",
                    "bytes": 1},
            "RPE": {"operator": "RPE", "op_code": 0xE8, "operand1": None, "operand2": None, "addressing": "Imm",
                    "bytes": 1},
            "RP": {"operator": "RP", "op_code": 0xF0, "operand1": None, "operand2": None, "addressing": "Imm",
                   "bytes": 1},
            ...
            "SBB A": {"operator": "SBB A", "op_code": 0x9F, "operand1": "A", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "SBB B": {"operator": "SBB B", "op_code": 0x98, "operand1": "B", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "SBB C": {"operator": "SBB C", "op_code": 0x99, "operand1": "C", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "SBB D": {"operator": "SBB D", "op_code": 0x9A, "operand1": "D", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "SBB E": {"operator": "SBB E", "op_code": 0x9B, "operand1": "E", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "SBB H": {"operator": "SBB H", "op_code": 0x9C, "operand1": "H", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "SBB L": {"operator": "SBB L", "op_code": 0x9D, "operand1": "L", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "SBB M": {"operator": "SBB M", "op_code": 0x9E, "operand1": "M", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            ...
            "XRA B": {"operator": "XRA B", "op_code": 0xA8, "operand1": "B", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "XRA C": {"operator": "XRA C", "op_code": 0xA9, "operand1": "C", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "XRA D": {"operator": "XRA D", "op_code": 0xAA, "operand1": "D", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "XRA E": {"operator": "XRA E", "op_code": 0xAB, "operand1": "E", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "XRA H": {"operator": "XRA H", "op_code": 0xAC, "operand1": "H", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "XRA L": {"operator": "XRA L", "op_code": 0xAD, "operand1": "L", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
            "XRA M": {"operator": "XRA M", "op_code": 0xAE, "operand1": "M", "operand2": None, "addressing": "Reg",
                      "bytes": 1},
