...
class Example(wx.Frame):
    ...
    def init_ui(self):
        ...
        vertical_box.Add(self.blue_leds, 1, wx.EXPAND)
        vertical_box.Add(self.green_leds, 1, wx.EXPAND)
        vertical_box.Add(self.orange_leds, 1, wx.EXPAND)
        vertical_box.Add(self.red_leds, 1, wx.EXPAND)
