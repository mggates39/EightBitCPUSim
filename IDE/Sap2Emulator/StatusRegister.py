...
class StatusRegister(wx.Panel):
    def __init__(self, parent):
        ...
        carry_box.Add(self.carry_flag, 0, wx.ALL, 5)
        carry_box.Add(self.carry_led, 0, wx.ALL, 5)
        ...
        zero_box.Add(self.zero_flag, 0, wx.ALL, 5)
        zero_box.Add(self.zero_led, 0, wx.ALL, 5)
        ...
        negative_box.Add(self.minus_flag, 0, wx.ALL, 5)
        negative_box.Add(self.minus_led, 0, wx.ALL, 5)

        vertical_box.Add(carry_box, 1, wx.EXPAND)
        vertical_box.Add(zero_box, 1, wx.EXPAND)
        vertical_box.Add(negative_box, 1, wx.EXPAND)
