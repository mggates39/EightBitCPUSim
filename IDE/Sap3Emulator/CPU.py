...
class CPU(wx.Panel):
    def __init__(self, parent):
        ...
        self.sizer.Add(self.pc, pos=(0, 0), span=(1, 2), flag=wx.EXPAND)
        self.sizer.Add(self.sp, pos=(0, 2), span=(1, 2), flag=wx.EXPAND)
        self.sizer.Add(self.a_register, pos=(1, 0), flag=wx.EXPAND)
        self.sizer.Add(self.sr, pos=(1, 1), flag=wx.EXPAND)
        self.sizer.Add(self.b_register, pos=(1, 2), flag=wx.EXPAND)
        self.sizer.Add(self.c_register, pos=(1, 3), flag=wx.EXPAND)
        self.sizer.Add(self.d_register, pos=(2, 0), flag=wx.EXPAND)
        self.sizer.Add(self.e_register, pos=(2, 1), flag=wx.EXPAND)
        self.sizer.Add(self.h_register, pos=(2, 2), flag=wx.EXPAND)
        self.sizer.Add(self.l_register, pos=(2, 3), flag=wx.EXPAND)
