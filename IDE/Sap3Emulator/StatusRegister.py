...
class StatusRegister(wx.Panel):
    def __init__(self, parent):
        ...
        self.carry_flag = wx.StaticText(self, label="C", style=wx.ALIGN_CENTER)
        ...
        negative_box = wx.BoxSizer(wx.VERTICAL)
        self.minus_flag = wx.StaticText(self, label="S", style=wx.ALIGN_CENTER)
        self.minus_led = LED(self, light_color, dark_color)
        negative_box.Add(self.minus_flag, 0, wx.TOP | wx.ALIGN_CENTER, 12)
        negative_box.Add(self.minus_led, 0, wx.ALL | wx.ALIGN_CENTER, 5)

        horizontal_box.Add(carry_box, 1, wx.ALIGN_CENTER)
        horizontal_box.Add(zero_box, 1, wx.ALIGN_CENTER)
        horizontal_box.Add(negative_box, 1, wx.ALIGN_CENTER)
