...
from Sap3Assembler.Segment import MAX_ADDRESS
...
class StackRegister(wx.Panel):
    def __init__(self, parent):
        ...
        self.buffer = 0
        self.box = wx.StaticBox(self, wx.ID_ANY, "Stack Register", wx.DefaultPosition, (200, 100))
        ...
        self.leds = LEDArray(self.box, 16, topic="sp.set_value", size=10, mode=MODE_HEX)
